...
SELECT pachet1_prof.f_numar(80)
FROM DUAL;
...
EXECUTE pachet2_prof.p_dept(1,'Economic',200,2000);

SELECT * FROM dept_prof WHERE department_id=1;
...
BEGIN
   pachet2_prof.p_dept(1,'Economic',99,2000);
